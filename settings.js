...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "suho~Q2kVBQ7A#DJiqDBmD0PRtrl_6qIrD1N2tofe37kCeq5EWDRK6wJg",
    // add your Session Id make sure it starts with suho~

    PREFIX: process.env.PREFIX || ".",
    // add your prefix for bot

    BOT_NAME: process.env.BOT_NAME || "ChiefMate",
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://imgur.com/yARH9Rn",
    // add custom menu and mention reply image url

    ALIVE_IMG: process.env.ALIVE_IMG || "https://imgur.com/yARH9Rng",
    // add img for alive msg

    LIVE_MSG: process.env.LIVE_MSG || 
`> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ

ᴋᴇᴇᴘ ᴜsɪɴɢ ✦Chiefmate✦ ғʀᴏᴍ Timtech⚡
...
> ɢɪᴛʜᴜʙ : github.com/NaCkS-ai/SungSu-ho-MD`,
    ...
    STICKER_NAME: process.env.STICKER_NAME || "ChiefMate",
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Timtech*",
    ...
    DEV: process.env.DEV || "233595885532",
